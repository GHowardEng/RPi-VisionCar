...
void CControlPi::small_turn(int dir)
{
...
void CControlPi::readInput(string input)
{
	...
	if (input[0] == 'x')
			...
			else if (input[0] == 'q' && drive == STOP)
			{
				CControlPi::small_turn(LEFT);
			}
			else if (input[0] == 'e' && drive == STOP)
			{
				CControlPi::small_turn(RIGHT);
			}
